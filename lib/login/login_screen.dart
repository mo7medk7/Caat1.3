...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        backgroundColor:
            provider.isDarkMode() ? MyTheme.blueDarkColor : MyTheme.whiteColor,
            ...
            children: [
              ...
              Padding(
                ...
                child: provider.isDarkMode()
                    ? Image.asset('assets/images/helloiconwhite.png')
                    : Image.asset('assets/images/helloicon.png'),
              ),
              Padding(
...
/////////////////////////////////////////////////////
        ...
        if (user == null) {
          ...
          return DialogUtils.showMessage(context, "nulluser");
        }
        /////////////////////////////////////////
